                  ...
                  child: Column(
                    ...
                    children: [
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text("${widget.petitionModel.petitionerName} ${widget.petitionModel.petitionerSurname}",overflow: TextOverflow.ellipsis, style: TextStyle(
                ...
                child: Row(
                  children: [
                    InkWell(
                        ...
                        child: Icon(widget.petitionModel.review ?? false ? Iconsax.like_15 : Iconsax.like_1)
                    ),
                    SizedBox(
                      width: 5,
                    ),
                ...
                child: Row(
                  children: [
                    InkWell(
                      ...
                      child: Icon(!(widget.petitionModel.review ?? true) ? Iconsax.dislike5 : Iconsax.dislike),
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      widget.petitionModel.commentNumber.toString(),
                      style: TextStyle(
                          color: Colors.black,
                          fontSize: 15,
                        ),
