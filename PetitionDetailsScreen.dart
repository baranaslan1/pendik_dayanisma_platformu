                              ...
                              child: Column(
                                ...
                                children: [
                                  Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text("${petitionModel!.petitionerName} ${petitionModel!.petitionerSurname}",overflow: TextOverflow.ellipsis, style: TextStyle(
                            ...
                            child: Row(
                              children: [
                                InkWell(
                                    ...
                                    child: Icon(petitionModel?.review ?? false ? Iconsax.like_15 : Iconsax.like_1)
                                ),
                                SizedBox(
                                  width: 5,
                                ),
                            ...
                            child: Row(
                              children: [
                                InkWell(
                                  ...
                                  child: Icon(!(petitionModel?.review ?? true) ? Iconsax.dislike5 : Iconsax.dislike),
